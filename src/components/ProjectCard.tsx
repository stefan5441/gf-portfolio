...
export default function ProjectCard({ image, frontPageGif, title, pillText, description, year }: Project) {
  ...
  return (
    ...
    >
      <div>
        <img src={isHovered ? frontPageGif : image} className="rounded-xl" />
